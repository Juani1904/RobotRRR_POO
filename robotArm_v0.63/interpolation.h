...
public:
  ...
  float setInterpolation(float px, float py, float pz, float pe, float v = 0); // cambiado de void a float para retornar tiempo
  ...
  float setInterpolation(Point p1, float v = 0); // cambiado de void a float para retornar tiempo
  float setInterpolation(Point p0, Point p1, float v = 0); // cambiado de void a float para retornar tiempo
