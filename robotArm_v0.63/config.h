...
#define END_EFFECTOR_OFFSET 50.0 // FOR GRIPPER PUMA3D
...
#define X_HOME_STEPS 665 //765 //860 // STEPS FROM X_ENDSTOP TO INITIAL_XYZ FOR UPPER ARM
#define Y_HOME_STEPS 1390 //1940 // STEPS FROM Y_ENDSTOP TO INITIAL_XYZ FOR LOWER ARM
#define Z_HOME_STEPS 2450 // STEPS FROM Z_ENDSTOP TO INITIAL_XYZ FOR ROTATION CENTER
...
#define HOME_DWELL 200 // INCREASE TO SLOW DOWN HOMING SPEED
...
//GRIPPER SETTINGS
#define GRIPPER 2 //GRIPPER MOTOR IN USE
        // 0: 28BYJ-48 MICRO STEPPER MOTOR
        // 1: 9G SERVO OR MG996 SERVO EQUIVALENT
        // 2: 28BYJ-48 HACKED STEPPER MOTOR WITH A4988 ON E1
...
//PRINT REPLY SETTING
//se desactivo la respuesta de comando procesado
...
#define Z_MIN -88 // -140.0 //MINIMUM Z HEIGHT OF TOOLHEAD TOUCHING GROUND
...
//ENDSTOPS CHECK. DEFAULT DELAYS ON HOME_DWELL = 1400
#define X_CHECK_DELAY 4 // WAITING TIME TO ASSUME LACK OF POWER OR ELECTROMECHANICAL FAILURE (default 4 seconds)
#define Y_CHECK_DELAY 7 // WAITING TIME TO ASSUME LACK OF POWER OR ELECTROMECHANICAL FAILURE (default 7 seconds)
#define Z_CHECK_DELAY 7 // WAITING TIME TO ASSUME LACK OF POWER OR ELECTROMECHANICAL FAILURE (default 7 seconds)
#define E0_CHECK_DELAY 3 // WAITING TIME TO ASSUME LACK OF POWER OR ELECTROMECHANICAL FAILURE (default 3 seconds)
